...
public class Menu extends State implements Statemethods
{
	...
	BufferedImage[] TextBoxOne;
	BufferedImage[] TextBoxTwo;
	...
	public Menu(Game game) 
	{
		...
		TextBoxOne = TextBox.loadBoxImages("/TextBoxMedium.png");
		TextBoxTwo = TextBox.loadBoxImages("/TextBoxMedium.png");
		
		Props.loadPropImage("/icon.png");
	}
	...
	private void loadButtons()
	{
		...
		//Novo Jogo
		buttons[0] = new MenuButtons((int) (32 * Game.SCALE), (int) (112 * Game.SCALE), 0, Gamestate.PLAYING);
		//Continuar
	...
	public void draw(Graphics g) 
	{
		...
		if (tick<15)
		{
			TextBox.draw(g, TextBoxOne);
		}

		if (tick>20 && tick<21)
		{
			
			TextBox.draw(g, TextBoxTwo);
		}
