...
public class Constants 
{
	...
	{
		public static final int FLAG_ONE_X = 0 * (int)(Game.SCALE);
		public static final int FLAG_ONE_Y = 0 * (int)(Game.SCALE);
		
		public static final int FLAG_TWO_X = 0 * (int)(Game.SCALE);
		public static final int FLAG_TWO_Y = 0 * (int)(Game.SCALE);
		
		public static final int FLAG_TREE_X = 0 * (int)(Game.SCALE);
		public static final int FLAG_TREE_Y = 0 * (int)(Game.SCALE);
		
		public static final int FLAG_FOUR_X = 0 * (int)(Game.SCALE);
		public static final int FLAG_FIVE_Y = 0 * (int)(Game.SCALE);
	}
