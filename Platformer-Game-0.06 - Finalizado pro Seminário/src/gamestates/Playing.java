...
///////////////////////////////////////////////////////////////////////////////
	...
	public static boolean dashEnable = false;
	
	//Teleportar para qualquer checkpoint
	private static int local = 0;
	public static int black=255;
...
//		}
	...
	private void createTrash()
	{
		...
		objTrashThree = new Trash("/TrashTwo.png", 3264, 2320, player, miniplayer);
		...
		objTrashEight = new Trash("/TrashTwo.png", 5328, 3200, player, miniplayer);
	...
	private void createCheckPoint()
	{
		...
		//Usar para testes:
		checkPointSeven = new CheckPoint(-1000, -1000, player);
	}
