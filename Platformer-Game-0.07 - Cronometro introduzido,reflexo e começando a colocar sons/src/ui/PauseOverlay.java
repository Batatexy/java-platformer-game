...
public class PauseOverlay {
	...
	public void update()
	{
		...
		if (Player.finalTimerTrigger == false)
			Player.setTimer();
	}
	...
	public void draw(Graphics g)
	{
		...
		if (playing.paused==true)
		{
			...
			g.drawString(Player.finalTimerMinString + ":" + Player.finalTimerSecString + ":" + Player.finalTimerMilString, (int)((188) * Game.SCALE), (int)((60) * Game.SCALE));
			g.drawString(Game.collectedTrashes + "", (int)((188) * Game.SCALE), (int)((80) * Game.SCALE));
			g.drawString(Game.deathCount + "",       (int)((188) * Game.SCALE), (int)((100) * Game.SCALE));
			g.drawString(Game.attemptCount + "",     (int)((188) * Game.SCALE), (int)((120) * Game.SCALE));
			
			Props.draw(g, timer,     (int)((43) * Game.SCALE),   (int)( (11.5) * Game.SCALE), 0, 0);
			Props.draw(g, trashProp, (int)((43) * Game.SCALE),   (int)( (16.5) * Game.SCALE), 0, 0);
			Props.draw(g, skull,     (int)((43) * Game.SCALE),   (int)( (21.5) * Game.SCALE), 0, 0);
			Props.draw(g, replay,    (int)((43) * Game.SCALE), (int)( (26.5) * Game.SCALE), 0, 0);
