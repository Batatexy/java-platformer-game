...
public class Menu extends State implements Statemethods
{
	...
	private void loadButtons()
	{
		...
		//Continuar
		buttons[1] = new MenuButtons((int) (112 * Game.SCALE), (int) (112 * Game.SCALE), 2, Gamestate.PLAYING);
		//Sair do Jogo
	...
	public void keyPressed(KeyEvent e) 
	{
		...
		{	
			...
			case KeyEvent.VK_X:
			{
				if ((player.getDash() == 0) && (player.getDashPressed() == false) && (Playing.dashEnable==true))
				{
					player.setDash(1);
