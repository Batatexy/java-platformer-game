...
public class Playing extends State implements Statemethods
{
	...
	private static boolean zoomPressed;
	
	public static float multiplierXLevelOffsetRightLeftVar=100, multiplayerVarX=1.2f, multiplierXLevelOffsetRightLeft=multiplierXLevelOffsetRightLeftVar;
	public static float  xLevelOffsetRightLeft = 0, xLevelOffsetRightLeftMax=450;
	
	public static float multiplierYLevelOffsetRightLeftVar=100, multiplayerVarY=1.2f, multiplierYLevelOffsetRightLeft=multiplierXLevelOffsetRightLeftVar;
	public static float  yLevelOffsetRightLeft = 0, yLevelOffsetRightLeftMax=450;
	
	
	private int leftBorderVar = (int)(0.46 * Game.GAME_WIDTH);
...
///////////////////////////////////////////////////////////////////////////////
	...
	public void update() 
	{
		if (!player.getMoving() && !player.getJump() && !player.getInAir() && zoomPressed)
		//if (!player.getMoving() && !player.getJump() && !player.getInAir() && player.getHitbox().x > 3344 * Game.SCALE)
		{
				if (multiplierXLevelOffsetRightLeft > 5)
					multiplierXLevelOffsetRightLeft/=multiplayerVarX;
		...
		{
			leftBorder = leftBorderVar;
			rightBorder = rightBorderVar;
			
			multiplierXLevelOffsetRightLeft=multiplierXLevelOffsetRightLeftVar;
		...
		//if (!player.getMoving() && !player.getJump() && !player.getInAir() && player.getHitbox().x > 3344 * Game.SCALE)
		{
				if (multiplierYLevelOffsetRightLeft > 5)
					multiplierYLevelOffsetRightLeft/=multiplayerVarY;
		...
		else
		{
			...
			multiplierYLevelOffsetRightLeft=multiplierYLevelOffsetRightLeftVar;
